...
a multi-agent strategic substrate. These results provide empirical evidence that
shared RL policies can support scalable, real-time, persona-conditioned NPC
control and that trajectory traceability is central to the method.
\end{abstract}
...
those observations. Engine integration also remains a practical step: the
policy must serialize game state, tolerate asynchronous events, and preserve
the sub-frame inference profile observed in the Python benchmark.
