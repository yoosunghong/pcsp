...
| OOD leakage + sensitivity | 6 splits: zero ID/exact/high-lexical leaks; excluding 7 semantic-neighbor test IDs changes any of 24 evaluations by at most 2.19 pp | OOD identification results are not driven by copies or the flagged near-neighbor cases |
...
![OOD persona leakage audit](research/results/ood_leakage_audit/ood_leakage_audit.png)
